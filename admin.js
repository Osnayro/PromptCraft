...
/**
 * PromptCraft — Administración
 * Gestión de usuarios autorizados desde Firestore.
 * Acceso con Google Auth y verificación contra la colección "admins".
 */
...
async function agregarUsuario() {
    ...
    elementos.btnAddUser.disabled = true;
    try {
        ...
        elementos.btnAddUser.disabled = false;
    }
}
...
async function cargarUsuarios() {
    ...
    elementos.usersList.innerHTML = '<p class="loading-message">Cargando usuarios...</p>';
